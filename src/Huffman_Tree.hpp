...
private:
	...
	void preOrdem(std::shared_ptr<NO_Huffman> no, ofstream &arquivo);
	void posOrdem(std::shared_ptr<NO_Huffman> no, ofstream &arquivo);
	void central(std::shared_ptr<NO_Huffman> no, ofstream &arquivo);
public:
	Huffman_Tree() {}
	//~Huffman_Tree() {}
